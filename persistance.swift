...
var defaultCrafts = [Craft(title: "Origami",
                     ...
                     Craft(title: "Embroidery",
                           ...
                           image: ["A40", "A41", "A42"]),
                     Craft(title: "Digital art",
                           description: "Digital art is a term used to describe art that is made or presented using digital technology. Digital art can be computer generated, scanned or drawn using a tablet and a mouse.",
                           materials: ["Tablet/computer", "Stylus", "Drawing app"],
                           link: ["Beginner’s Guide to Digital Painting", "https://paintable.cc/digital-painting-the-ultimate-beginners-guide/"],
                           image: ["a"]),
                     Craft(title: "Air Dry Clay",
                           description: "Air-dry clays were developed for artists who desire the integrity of clay but do not have easy access to a kiln. Most air-dry clays are mineral based and have properties comparable to those of traditional clays. They harden within a few days and do not need to be fired to create a permanent form. As such, they can be used to make a variety of things.",
                           materials: ["Air Dry clay", "Sculpting tools (can use anything available)", "Water"],
                           link: ["Air Dry Clay Ideas (video)", "https://www.youtube.com/watch?v=frIVB6DlA7A"],
                           image: ["a"]),
                     Craft(title: "Paper cutting",
                           description: "Paper cutting is an art form where beautiful designs and patterns are cut from a single sheet of paper, using only scissors or a blade.",
                           materials: ["Paper", "Scissors/pen knife/art knife", "Pencil", "Paper cutting board + flat surface"],
                           link: ["Introduction To Paper Cutting (video)", "https://www.youtube.com/watch?v=sl2WcHgoXE0"],
                           image: ["a"]),
                     Craft(title: "Diorama",
                           description: "A diorama is a replica of a scene, typically a three-dimensional full-size or miniature model. Though dioramas usually display a historical time period, a nature scene, or a fictional situation, you can make one to show anything that you're interested in making. You can use anything you want to make your diorama, including clay, paper, cardboard etc.",
                           materials: ["Construction paper", "Modelling clay", "Glue", "Scissors", "Paint/markers", "Miniature figures (eg. lego)"],
                           link: ["How to make a diorama", "https://www.wikihow.com/Make-a-Diorama"],
                           image: ["a"]),
                     Craft(title: "Jewellery Making",
                           description: "Jewellery making is the process of creating ornamental pieces worn for personal decoration or adornment. Various types of jewellery making incorporate different skills (eg. beaded jewellery, wire jewellery etc.)",
                           materials: ["It depends on the type of jewellery you are making (beads, wire, string)", "Pliers/wire cutters etc.", "Learn how to make basic jewellery at a workshop (eg. Fat Anvil Studios workshops)"],
                           link: ["Making Basic Jewellery", "https://www.thesprucecrafts.com/learn-how-to-make-jewelry-4118372"],
                           image: ["a"]),
                     Craft(title: "Leather Crafting",
                           description: "Leatherworking, also known as leather crafting, is the practice of making leather into practical objects or artwork, using moulding, dyeing, carving, stamping, and fabrication techniques.",
                           materials: ["Try out some workshops to get started (eg. Stone For Gold)"],
                           link: ["Leatherworking 101", "https://www.thecrucible.org/guides/leatherworking/"],
                           image: ["a"]),
                     Craft(title: "Pottery",
                           ...
                           materials: ["Clay", "Carving tools", "Water", "Sponge", "Paint (optional)", "Glaze (optional)", "Try a pottery class (eg. Mud Rock Ceramics)"],
                           link: ["Introduction to Pottery (video)", "https://youtu.be/BUFfEa1rknM"],
                           image: ["art21.1", "art21.2", "art21.3"]),
                     Craft(title: "Wood Carving",
                           description: "Wood carving is a form of woodworking using cutting tools to make a wooden figure.",
...
var defaultSports = [Sport(title: "Basketball",
                           ...
                           suggestedPlace: ["Book Basketball Facilities", "https://www.myactivesg.com/Facilities?sport=basketball&q=basketball&type=All"],
                           image: ["S1","S2","S3"]),
                     Sport(title: "Soccer",
                           ...
                           equipment: ["Football", "Goal posts", "Field/open space"],
                           link: ["Basic Football Skills", "https://www.onlinesocceracademy.com/soccer-training-videos"],
                           suggestedPlace: ["Book Football Facilities", "https://www.myactivesg.com/Facilities/Fields"],
                           image: ["S4", "S5", "S6"]),
                     Sport(title: "Archery",
                           ...
                           equipment: ["Bow", "Arrow", "Target"],
                           link: ["Archery for Beginners", "https://www.youtube.com/watch?v=feKRWOA43kY"],
                           suggestedPlace: ["Ace Archery", "https://www.ace-archery.com.sg/"],
                           image: ["S7","S8","S9"]),
                     Sport(title: "Tag Rugby",
                           ...
                           suggestedPlace: ["Book a field to play Tag Rugby", "https://www.myactivesg.com/facilities/fields"],
                           image: ["S10","S11","S12"]),
                     Sport(title: "Swimming",
                           ...
                           equipment: ["Swimming pool", "Swimming costume"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=gh5mAtmeR3Y"],
                           suggestedPlace: ["Find ActiveSG Swimming Pools", "https://www.myactivesg.com/Facilities/Swimming-Pools"],
                     ...
                     Sport(title: "Badminton",
                           ...
                           suggestedPlace: ["Book Badminton Facilities", "https://www.myactivesg.com/Facilities?sport=All&q=badminton&type=All"],
                     ...
                     Sport(title: "Volleyball",
                           ...
                           suggestedPlace: ["Book Volleyball Facilities", "https://www.myactivesg.com/Facilities?sport=volleyball&q=volleyball&type=All"],
                           image: ["S21","S22"]),
                     Sport(title: "Bouldering",
                           description: "Bouldering is a form of rock climbing done on a shorter wall with a soft landing mat. Bouldering does not require a harness and is a test of both physical and mental strength.",
                           benefits: ["Strengthens your muscle", "Improves cardiovascular endurance"],
                           equipment: ["Climbing shoes", "Rock wall"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=b2v4brHpdxY"],
                           suggestedPlace: ["Kinetics Climbing", "https://www.kineticsclimbing.com.sg"],
                           image: ["S23"]),
                     Sport(title: "Bowling",
                           description: "Bowling is a game in which you roll a heavy ball down a narrow track towards a group of bowling pins and try to knock down as many of them as possible.",
                           ...
                           suggestedPlace: ["Sonic Bowl", "https://www.safra.sg/amenities-offerings/sonic-bowl"],
                           image: ["S24", "S25"]),
                     Sport(title: "Kayaking",
                           ...
                           suggestedPlace: ["Adventure Paddlers Equipment Rental", "https://adventurepaddlers.com.sg/rental/"],
                           image: ["S26"]),
                     Sport(title: "Capture The Flag",
                           ...
                           suggestedPlace: ["Suggested Place", "Any large open space"],
                           image: ["S27"]),
                     Sport(title: "Cycling",
                           ...
                           suggestedPlace: ["Cycling trails in SG", "https://www.homage.sg/resources/best-cycling-trails-routes-singapore/"],
                           image: ["S28"]),
                     Sport(title: "Darts",
                           description: "An indoor game in which darts are thrown at a circular target marked with numbers in order to score points.",
                           ...
                           equipment: ["Dartboard", "Darts","Scoreboard or sheet of paper to keep score on"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=VsDbP_1x2VY"],
                           suggestedPlace: ["IDarts", "http://www.idarts.com.sg"],
                           image: ["S29","S30"]),
                     Sport(title: "Scuba Diving",
                           ...
                           equipment: ["Please do not try scuba diving without training or an instructor"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=kJMmLVTX0bk"],
                           suggestedPlace: ["Scuba Knights", "https://www.scubaknights.com/"],
                     ...
                     Sport(title: "Dodgeball",
                           ...
                           suggestedPlace: ["Suggested Place", "Any large enclosed space"],
                           image: ["S35"]),
                     Sport(title: "Floorball",
                           ...
                           equipment: ["Floorball stick", "Floorball ball", "Goal posts"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=fX0gYzKHjZU"],
                           suggestedPlace: ["Book Floorball Facilities", "https://www.myactivesg.com/Facilities?sport=floorball&q=&type=All"],
                           image: ["S36"]),
                     Sport(title: "Golf",
                           ...
                           equipment: ["Golf ball", "Putter", "Golf course"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=1iOa2ZwGhbU"],
                           suggestedPlace: ["Marina Bay Golf Course", "https://www.mbgc.com.sg"],
                     ...
                     Sport(title: "Axe Throwing",
                           ...
                           suggestedPlace: ["Axefactor", "https://axefactor.com.sg/"],
                           image: ["S53","S54"]),
                     Sport(title: "Boxing",
                           ...
                           suggestedPlace: ["Legends classes", "https://www.legends.com.sg"],
                           image: ["S55"])]
