...
var defaultSports = [Sport(title: "Basketball",
                     ...
                     Sport(title: "Boxing",
                           ...
                           image: ["S55"]),
                     Sport(title: "Ice Skating",
                           description: "Ice skating is the recreation and sport of gliding across an ice surface on blades fixed to the bottoms of shoes also known as skates.",
                           benefits: ["Skating works nearly every muscle group in the body", "Improves joint flexibility", "Improved balance, coordination and weight management"],
                           equipment: ["No equipment needed"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=OFMlMaWEiZ4"],
                           suggestedPlace: ["Ice Skating Rink in Singapore", "https://www.therink.sg/public-skating-sessions/"],
                           image: ["S56", "S57", "S58"]),
                     Sport(title: "Captain's Ball",
                           description: "Captain’s Ball is a game similar to basketball played on an area marked with six circles by teams of seven or more players who try to pass the ball to the player stationed in the end circle.",
                           benefits: ["Improves teamwork", "Improves strategizing skills"],
                           equipment: ["1 ball"],
                           link: ["Rules", "https://www.sportsrec.com/356830-the-netball-rules-and-regulations-of-the-game.html"],
                           suggestedPlace: ["Suggested Place", "Any empty space"],
                           image: ["S59", "S60"]),
                     Sport(title: "Rock Climbing",
                           description: "Rock climbing is a sport in which participants climb up, across, or down natural rock formations or artificial rock walls. The goal is to reach the summit of a formation or the endpoint of a usually pre-defined route without falling.",
                           benefits: ["Improves strength, endurance, agility and balance", "Improves mental control and problem solving skills"],
                           equipment: ["No equipment needed"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=rhcDSzw-MOk"],
                           suggestedPlace: ["The Best Rock Climbing And Bouldering Gyms Singapore", "https://www.timeout.com/singapore/sport-and-fitness/the-best-rock-climbing-gyms-in-singapore"],
                           image: ["S61", "S62", "S63"]),
                     Sport(title: "Roller Skating",
                           description: "Roller skating is the act of travelling on surfaces with roller skates. It is a recreational activity, a sport, and a form of transportation. Roller rinks and skate parks are built for roller skating, though it can also take place on streets, sidewalks, and bike paths.",
                           benefits: ["Improves balance", "Relieves stress"],
                           equipment: ["Roller skates", "Knee pads", "Elbow pads", "Helmet"],
                           link: ["Tutorial", "https://skatefresh.com/how-to-skate-dance-on-roller-skates-for-beginners-first-steps/"],
                           suggestedPlace: ["Suggested Place", "Nearby park"],
                           image: ["S64", "S65", "S66"]),
                     Sport(title: "Frisbee",
                           description: "A frisbee, also called a flying disc or simply a disc, is a gliding toy or sporting item that is generally made of injection-moulded plastic and roughly 8 to 10 inches in diameter with a pronounced lip.",
                           benefits: ["Burns calories and increases metabolism", "Improved endurance", "Better agility as a result of quick turns, throws, pivots, and jumps", "Boosts moods", "Enhances social interactions", "A complete body workout"],
                           equipment: ["Frisbee"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=lNQexzgzvw4"],
                           suggestedPlace: ["Suggested Place", "An open space"],
                           image: ["S67", "S68", "S69", "S70"]),
                     Sport(title: "Table Tennis",
                           description: "A sport in which two or four players hit a lightweight ball, also known as the ping-pong ball, back and forth across a table using small solid rackets. The game takes place on a hard table divided by a net.",
                           benefits: ["Improves hand-eye coordination", "Develops mental acuity", "Improves reflexes", "Burns calories", "Offers a social outlet", "Keeps your brain sharp", "Improves coordination", "Improves balance", "Stimulates various different parts of the brain"],
                           equipment: ["Table Tennis Paddle", "Ping Pong Ball"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=xnMf8J6UFZs"],
                           suggestedPlace: ["Book Table Tennis Facilities", "https://www.myactivesg.com/Facilities?sport=table-tennis&q=table%20tennis&type=All"],
                           image: ["S71", "S72", "S73", "S74"]),
                     Sport(title: "Paintball",
                           description: "Paintball is a game that originated in America in the early eighties which involves teams or individual players competing against each to eliminate other players by hitting them with paint-filled pellets fired from a compressed gas powered gun, otherwise known as a marker, and complete game objectives.",
                           benefits: ["Adds variety to your regular routine", "Full Body Workout", "Increases Endurance", "Increases Strength", "Increases interpersonal Skills and Self Confidence", "Great for weight loss and overall health", "Major Stress Relief", "Promotes Teamwork"],
                           equipment: ["No equipment needed"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=z7_OhXfOUDs"],
                           suggestedPlace: ["Red Dynasty Paintball Park", "https://red-dynasty-paintball-park.business.site/"],
                           image: ["S75", "S76", "S77", "S78"]),
                     Sport(title: "Rope Skipping",
                           description: "A form of exercise that involves swinging a rope around your body and jumping over it as it passes under your feet.",
                           benefits: ["Improves heart health", "Increases concentration", "Improves coordination", "Increases stamina and gets rid of fatigue", "Increases body flexibility", "Boost mental health", "Decreases belly fat", "Strengthens your bones", "Improves pulmonary function"],
                           equipment: ["Jump rope"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=FJmRQ5iTXKE&themeRefresh=1"],
                           suggestedPlace: ["Suggested Place", "Any empty space"],
                           image: ["S79", "S80", "S81", "S82"]),
                     Sport(title: "Sailing",
                           description: "The sport of using wind to power sails and propel the boat forward rather than engines.",
                           benefits: ["Develops Muscle Strength", "Improve Cardiovascular Health", "Keep Your Bones Strong", "Helps with Mental Wellness", "Improve Concentration", "Reduce Stress", "Improve Spatial Awareness and Visual Acuity"],
                           equipment: ["No equipment needed"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=wgmoJRXPUJQ"],
                           suggestedPlace: ["Sign up for a Basic Sailing Course", "https://sailing.org.sg/adults/basic-sailing-course/"],
                           image: ["S83", "S84", "S85", "S86"]),
                     Sport(title: "Sepak Takraw",
                           description: "A foot volleyball game where players touch as well as handle the ball using only their feet, knee, chest and head.",
                           benefits: ["Increase in strength, stamina and endurance"],
                           equipment: ["Rattan ball", "Net"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=N-ZInLq317c"],
                           suggestedPlace: ["Suggested Place", "Any open space"],
                           image: ["S87"]),
                     Sport(title: "Sky Diving",
                           description: "Free-fall until a certain altitude from an aircraft or a mountain, fly about 30 to 180 seconds, and then gradually float in the air until you land on safe ground with a parachute.",
                           benefits: ["Endorphin Boost", "Better endurance", "Muscle Growth", "Increases Flexibility", "Change in Perception"],
                           equipment: ["No equipment needed"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=8tixsMIOGrw"],
                           suggestedPlace: ["Skydive Singapore", "https://www.skydivesingapore.com/"],
                           image: ["S88", "S89", "S90", "S91"]),
                     Sport(title: "Squash",
                           description: "A racquet sport played by two players or four players for doubles in a four-walled court with a small, hollow rubber ball.",
                           benefits: ["Improve cardiovascular health", "Increase strength and fitness", "Maintain a healthy weight", "Increase flexibility and strength in the back", "Promote good coordination, agility and flexibility", "Build hand–eye coordination"],
                           equipment: ["Racket", "Ball"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=xyLYd4vYEgE"],
                           suggestedPlace: ["Book Squash Facilities", "https://www.myactivesg.com/facilities/kallang-squash-centre"],
                           image: ["S92", "S93", "S94", "S95"]),
                     Sport(title: "Skateboarding",
                           description: "A form of recreation and sport, popular among youths, in which a person rides standing balanced on a small board mounted on wheels.",
                           benefits: ["Great for Relieving Stress", "Make You Stronger", "Great Cardio Workout", "Improve Coordination"],
                           equipment: ["Skateboard"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=p3NXd3DhH08"],
                           suggestedPlace: ["Place to skateboard in Singapore", "https://www.skatedragons.com"],
                           image: ["S96", "S97"]),
                     Sport(title: "Tchoukball",
                           description: "A non-contact team sport that emphasises on speed, teamwork and strategy.",
                           benefits: ["Promotes hand-eye coordination", "Develops skills that enhance physical and mental output."],
                           equipment: ["Tchoukball", "2 goals"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=o7SFVgHWhU8"],
                           suggestedPlace: ["Tchoukball website", "https://tchoukball.org.sg/services/"],
                           image: ["S98"]),
                     Sport(title: "Tennis",
                           ...
                           benefits: ["Increase aerobic capacities", "Lower resting heart rate and blood pressure", "Improve metabolic function", "Increase bone density", "Lower body fat", "Improve muscle tone, strength and flexibility", "Increase reaction times"],
                           equipment: ["Tennis racket", "Tennis ball"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=YqgcykDGB2A"],
                           suggestedPlace: ["Book Tennis Facilities", "https://www.myactivesg.com/facilities/st-wilfred-tennis-centre"],
                           image: ["S99", "S100", "S101", "S102"]),
                     Sport(title: "Tetherball",
                           description: "Hit the ball with your hand in a way that gets it past your opponent so that the rope winds completely around the tetherball pole.",
                           benefits: ["Develops hand-eye coordination skills"],
                           equipment: ["A stationary pole", "A rope", "1 ball"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=f4zMhLDIFJ4"],
                           suggestedPlace: ["Suggested Place", "Anywhere"],
                           image: ["S103"]),
                     Sport(title: "Tug Of War",
                           description: "Athletic contest between two teams at opposite ends of a rope, each team trying to drag the other across a centre line.",
                           benefits: ["Strengthens muscles", "Encourages teamwork", "Improve mental endurance", "Improves fitness"],
                           equipment: ["A rope", "Gloves"],
                           link: ["Tutorial", "https://www.youtube.com/watch?v=alAwJAZP-D0"],
                           suggestedPlace: ["Suggested Place", "An empty space"],
                           image: ["S104", "S105"])]
